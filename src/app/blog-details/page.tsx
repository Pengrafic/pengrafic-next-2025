...
export const metadata: Metadata = {
  title: "Blog Pengrafic | Encuentra informacion de las ultimas technologias",
  description: "Encuentra informacion de las ultimas technologias del frontend y backend",
  // other metadata
};
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                Los Mejores Componentes de Interfaz de Usuario para Sitios Web Modernos
                </h2>
                ...
                <div>
                  ...
                  En este artículo, exploramos las mejores librerías y frameworks de UI que te ayudarán a crear experiencias digitales fluidas, accesibles y visualmente impactantes. ¡Descubre cuál se adapta a tu proyecto!.
                  </p>
